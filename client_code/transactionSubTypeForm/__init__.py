from ._anvil_designer import transactionSubTypeFormTemplate
from anvil import *
import anvil.server


class transactionSubTypeForm(transactionSubTypeFormTemplate):
